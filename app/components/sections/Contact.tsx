          ...
          >
            {copiedType === "email" ? (
              <>
                ...
                {t("Copied Email!", "Email zkopírován!")}
              </>
            ) : (
              <>
                <svg
          ...
          >
            {copiedType === "discord" ? (
              <>
                ...
                <span className="text-[#CC8500]">
                  {t("Copied Discord!", "Discord Zkopírován")}
                </span>
              </>
            ) : (
              <>
                ...
                {t("Copy Discord", "Kopírovat Discord")}
              </>
            )}
          </button>
        </div>
